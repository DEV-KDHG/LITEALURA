package com.Karol_dev.LiterAlura.principal;
...
import com.Karol_dev.LiterAlura.model.RLibro;
...
import com.Karol_dev.LiterAlura.service.ConsumoApi;
import com.Karol_dev.LiterAlura.service.ConverteDados;
    ...
    public void buscaLibro(){
        ...
        if(listaRt.results().isEmpty()){
            ...
            if(verificaLibro.isEmpty()) {
                ...
                libro.setDescargas(listaRt.results().get(numLibro).descargas());
